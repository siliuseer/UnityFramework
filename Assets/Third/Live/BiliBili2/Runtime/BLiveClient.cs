...
namespace OpenBLive.Runtime
{
    ...
    public abstract class BLiveClient : IDisposable
    {
        ...
        /// 弹幕数据
        /// </summary>
        public ReceiveDanmakuEvent OnDanmaku;

        /// <summary>
        /// 赠送礼物
        /// </summary>
        public ReceiveGiftEvent OnGift;

        public ReceiveGuardBuyEvent OnGuardBuy;

        /// <summary>
        /// SC赠送
        /// </summary>
        public ReceiveSuperChatEvent OnSuperChat;

        /// <summary>
        /// SC删除
        /// </summary>
        public ReceiveSuperChatDelEvent OnSuperChatDel;

        /// <summary>
        /// 原始数据包
        /// </summary>
        public ReceiveRawNotice ReceiveNotice;

        /// <summary>
        /// 更新人气
        /// </summary>
        public EventHandler<int> UpdatePopularity;
